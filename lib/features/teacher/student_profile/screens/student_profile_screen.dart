    ...
    return SizedBox(
      ...
      child: RadarChart(
        RadarChartData(
          ...
          tickCount: 5,
          ticksTextStyle: AppTypography.labelSmall.copyWith(color: AppColors.textSecondary),
          tickBorderData: BorderSide(color: AppColors.divider),
          gridBorderData: BorderSide(color: AppColors.divider),
          radarBorderData: const BorderSide(color: AppColors.primary, width: 2),
          titleTextStyle: AppTypography.labelMedium.copyWith(color: AppColors.textPrimary),
          getTitle: (index, _) {
